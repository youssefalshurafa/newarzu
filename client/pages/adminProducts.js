...
const AdminProducts = () => {
  ...
  return (
    <>
      <Head>
        <title>{'Admin|Products|Arzu'}</title>
      ...
      <Layout>
        <div className=" relative overflow-hidden mx-auto">
          ...
          {category === 'Add a new category (+)' && (
            <div className="fixed bg-gray-200 inset-0 opacity-90 z-50">
              <div className="fixed  top-80 left-1/2 transform -translate-x-1/2 -translate-y-1/2 overscroll-contain shadow-md  bg-gray-100 z-50 px-4 py-6 rounded-lg">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 m-4 font-poppins font-semibold ">
            {products.map((product, i) => (
              ...
              >
                ...
                {confirm === product._id && (
                  <div className=" absolute bottom-9 left-5 z-60">
                    <div className=" space-y-2 text-xs md:text-lg  text-center font-poppins  bg-white p-6 rounded shadow-lg">
                      <div>
